...
<title><?php echo __( $wmso_mainttitle ); ?></title>
<style type="text/css">
body {
font-family: -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif;  color:#616161 /*#757575*/;
...
<div class="container">
  ...
  <h1><?php echo __( $wmso_mainttitle ); ?></h1>
  <p><?php echo __( $wmso_maintdesc ); ?></p>
  </div>
  </div>
</div>
